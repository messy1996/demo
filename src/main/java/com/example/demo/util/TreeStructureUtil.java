...
public class TreeStructureUtil {
    ...
    public static <T> List<T> listToTree(List<T> trees) throws IllegalAccessException {
        ...
        for (final T t : trees) {
            ...
            if (value != null) {
                if (pidAndTrees.get(value) != null) {
                    ...
                    pidAndTrees.put(value, new ArrayList<T>() {{
                        this.add(t);
                    }});
                }
        ...
        buildChildTree(rootList, pidAndTrees);
        return rootList;
    }
     ...
     * @throws IllegalAccessException
     */
    private static <T> void buildChildTree(List<T> currentTrees, HashMap<Object, List<T>> trees) throws IllegalAccessException {
        for (T t : currentTrees) {
            ...
            if (trees.get(currentId) != null) {
                ...
                buildChildTree(trees.get(currentId), trees);
            } else {
                setValue(t, children);
            }
        }
